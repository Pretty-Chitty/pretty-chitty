...
- outlet positions don't work for named outlet?
- default "z raised" amount for stacking to be clearer?
- ownerOrigin can't accept string? (but it works)
- raising has weird tween (default zlift ratio?)
- skips a timestamp in animation?
